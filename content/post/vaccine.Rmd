...
highchart() %>% 
     ...
     hc_add_series(data=df1$`Julio (25 junio a 15 julio - Telefónico)`, name='Julio 2020', color='salmon' ) %>% 
     hc_add_series(data=df1$`3ª y 4ª semana Julio (CAPI)`, name='3ª y 4ª semana Julio (CAPI)', color='darksalmon' ) %>% 
     hc_add_series(data=df1$`Septiembre (CAPI)`, name='Septiembre (CAPI)', color='pink' ) %>% 
     hc_add_series(data=df1$`Octubre (CAPI)`, name='Octubre (CAPI)', color='teal' ) %>% 
     hc_add_series(data=df1$`4 a 22 enero (Telefónico)*`, name='4 a 22 enero (Telefónico)', color='gold' )
```
